    ...
    <div className="safe-bottom fixed inset-x-0 bottom-0 z-40 border-t border-border bg-surface-raised/95 backdrop-blur">
      <div className="mx-auto flex max-w-lg items-center gap-3 px-4 py-3">
        ...
        <div className="flex flex-1 flex-col items-center">
          <span className="text-xs font-semibold uppercase tracking-wide text-white/40">מנוחה</span>
          <span dir="ltr" className="font-mono text-2xl font-extrabold tabular-nums text-primary">
